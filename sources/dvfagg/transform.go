...
// Vintage: the 3 most recent full DVF years, used to build the next refresh's
// raw file set. geo-dvf 2025 is published, so the window is 2023-2025. (The
// embedded artifact is regenerated by `gazetteer refresh --go-embed-update
// dvfagg`, a multi-GB per-department download; bump this and re-run when
// refreshing.) Bump on refresh.
var years = []string{"2023", "2024", "2025"}
